...
import { ActivityIndicatorIOS, Animated, Dimensions,
    NativeModules, Platform, ProgressBarAndroid, View } from 'react-native';

import MBHeader from './MBHeader';
import MBSegmentedControl from './MBSegmentedControl';
...
class ListContainer extends Component{
    ...
    render(){
        ...
        const content = React.Children.map(this.props.children, (child, idx) => {
          ...
          return <MeteorLoading>{React.cloneElement(child, {
        ...
        return(
            <View style={styles.container}>
                <View style={styles.headerWrapper}>
                    <ParallaxBackground
                      minHeight={this.state.stickyHeaderHeight + MBHeader.height}
                        maxHeight={EMPTY_CELL_HEIGHT + this.state.stickyHeaderHeight + MBHeader.height}
